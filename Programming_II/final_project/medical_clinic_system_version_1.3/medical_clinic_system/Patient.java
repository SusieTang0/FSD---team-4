...
public class Patient extends Person{
    ...
    public String toString(){
        ...
        newString.append(" | " );
        for(MedicalRecord record:this.medicalRecordsList){
            newString.append(record.toString() + " / ");
        }
        newString.append(String.valueOf(this.medicalRecordsList.size()));
    ...
    public String displaySimleInfo(){
        String temp = String.format(
        "\n *. Firstname: %-20s \t*. Lastname: %-20s " +
        "\n *. Age: %-25d \t*. Sex: %-20s " +
        "\n *. Date of Birth: %-15s \t*. Medical Card Number: %s" +
